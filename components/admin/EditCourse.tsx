...
import { useCreateCourseMutation, useEditCourseMutation } from '@/redux/features/courses/courseApi'
...
const EditCourse = ({course}: Props) => {
    const [editCourse, { isSuccess, error, isLoading, data }] = useEditCourseMutation()
